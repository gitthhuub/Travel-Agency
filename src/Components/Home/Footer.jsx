...
export default function Footer() {
  return (
    <Box bg={'rgb(26, 29, 46)'} color="white" paddingLeft={['20px', '50px']}>
      <Container as={Stack} maxW={'6xl'} py={[4, 10]}>
        <SimpleGrid columns={{ base: 1, sm: 2, md: 4 }} spacing={[4, 8]}>
          <Stack width={['100%', '150%']}>
            <Box display={'flex'} gap={'10px'}>
              <Image src={Logo} alt="logo" width={'25px'} height={'25px'} borderRadius={'30px'} />
              <ListHeader> Hilling</ListHeader>
            ...
            <Text textAlign={'left'}>
              Set ut perspiciatis undmnis iste <br />
              natus error sit voluptatem.
            </Text>
          </Stack>
